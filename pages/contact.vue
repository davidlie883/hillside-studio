    ...
    <div class="min-h-screen bg-gray-50 px-6 pt-24 pb-16 text-gray-900 md:px-12 lg:px-20 xl:px-28 2xl:px-36">
        <div class="mx-auto max-w-6xl">
            <div ref="heroRef" class="mb-14 max-w-3xl">
                ...
                <h1 class="mb-4 text-4xl font-bold md:text-5xl">Let's talk about your website</h1>
                <p class="text-lg leading-relaxed text-gray-600">
                    Have a project in mind or just want to ask a few questions? Fill in the form
                ...
                <div ref="infoCardRef" class="rounded-3xl bg-white p-8 shadow-sm">
                    ...
                    <div class="space-y-6">
                        <div class="contact-detail">
                            <p class="mb-1 text-sm uppercase tracking-wide text-gray-500">Email</p>
                            <p class="text-lg font-medium">hillsideconsultancy@gmail.com</p>
                        </div>

                        <div class="contact-detail">
                            <p class="mb-1 text-sm uppercase tracking-wide text-gray-500">Phone</p>
                        ...
                        <div class="contact-detail">
                            ...
                            <p class="text-lg font-medium">Melbourne, Australia</p>
                        </div>
                    </div>
                    ...
                    <div class="contact-detail mt-8 rounded-2xl bg-gray-100 p-5">
                        ...
                        <p class="leading-relaxed text-gray-600">
                            We help with clean website layouts, service pages, landing pages, and
                            simple business-focused designs.
                        </p>
                    </div>
                </div>
            ...
            <!-- Bottom buttons -->
            <div ref="bottomButtonsRef" class="mt-10 flex flex-wrap items-center gap-4">
                <NuxtLink
                    to="/"
